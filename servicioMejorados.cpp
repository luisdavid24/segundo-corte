#include <iostream>
int clase1,clase2,clase3,clase4,claseUsuario,jornadaUsuario,manana,tarde,mayor,i,llave;
...
int main(int argc, char** argv) {
	...
	cout<<"Escribe el numero de vecez que vas a meter datos en el programa: ";
	cin>>llave;
	i=0;
	while(i<llave)
	{	i++;
